...
const styles = StyleSheet.create({
  ...
  chipN: { borderWidth: 1, borderColor: colors.border, borderRadius: 14, paddingHorizontal: 10, paddingVertical: 4, backgroundColor: '#fff' },
  chipNOn: { backgroundColor: colors.brandDark, borderColor: colors.brandDark },
  chipNText: { color: colors.text, fontWeight: '700', fontSize: 12 },
  chipNTextOn: { color: '#fff' },
  composerActions: { flexDirection: 'row', alignItems: 'center', gap: 10, marginTop: 14 },
  photoBtn: { flexDirection: 'row', alignItems: 'center', gap: 7, borderWidth: 1, borderColor: colors.border, borderRadius: radius.md, paddingHorizontal: 14, paddingVertical: 12 },
  photoBtnText: { color: colors.text, fontWeight: '700' },
  post: { backgroundColor: colors.surface, borderRadius: radius.lg, padding: 14, borderWidth: 1, borderColor: colors.border, marginBottom: 14, ...shadow.card },
  postHi: { borderColor: colors.brand, borderWidth: 2 },
  postHead: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  postAuthor: { fontWeight: '800', color: colors.text, fontSize: 14 },
  postDate: { color: colors.textLight, fontSize: 12 },
  postText: { color: colors.text, fontSize: 15, marginTop: 10, lineHeight: 21 },
  postImg: { width: '100%', height: 220, borderRadius: radius.md, marginTop: 10 },
  ...
  commentInput: { flex: 1, backgroundColor: colors.muted,
    borderRadius: radius.md, paddingHorizontal: 14, paddingVertical: 9, color: colors.text },
  cSend: { color: colors.brand, fontWeight: '800' },
});
