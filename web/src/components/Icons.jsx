...
// Jeu d'icônes SVG (style Lucide) : trait fin, couleur héritée (currentColor),
// pour les rubriques de navigation. Aucune dépendance externe.
...
export const IconSearch = (p) => (
  <Ico {...p}><circle cx="11" cy="11" r="8" /><path d="m21 21-4.3-4.3" /></Ico>
);
